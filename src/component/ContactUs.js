                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    ...
                    <a
                      ...
                      className="px-3 py-1.5 md:px-4 md:py-2 bg-green-700 text-white rounded-lg hover:bg-green-800 transition-colors flex items-center gap-2 text-xs md:text-sm"
                    >
                      <svg
