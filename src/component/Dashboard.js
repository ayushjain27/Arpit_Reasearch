...
const AKVHomepage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Ananta Research - SEBI Registered Research Analyst | Equity Research
          Services
        </title>
        <meta
          name="description"
          content="Ananta Research provides SEBI registered equity research, technical analysis, fundamental analysis, and market insights for traders and investors in India."
        />
        <meta
          name="keywords"
          content="equity research, SEBI registered research analyst, technical analysis, fundamental analysis, market trends, Indian stock market, trading insights"
        />
        <link rel="canonical" href="https://www.arpitgoyal.in" />
        <meta
          property="og:title"
          content="Ananta Research - SEBI Registered Research Analyst"
        />
        <meta
          property="og:description"
          content="Professional equity research services for traders and investors in India."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.arpitgoyal.in" />
      ...
      <div className="min-h-screen bg-white">
        ...
        {/* Main Content - ADDED main landmark */}
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-xl text-blue-100 leading-relaxed">
                      ...
                      methodologies. Join our community to get actionable
                      insights created by leveraging advanced analytics and
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-3xl mx-auto mb-12">
                ...
                <p className="text-xl text-gray-600">
                  ...
                  quantitative data analysis to identify potential
                  opportunities.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow transform hover:-translate-y-1">
                  ...
                  <p className="text-gray-600">
                    Insights backed by real time data analysis and risk
                    assessment
                  </p>
                </div>
              </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-teal-100 mt-2">
                          We concentrate on high-probability setups with
                ...
                <div className="text-gray-400 text-sm space-y-4">
                  <div>
                    ...
                    <p>
                      ...
                      <br />
                      <span className="font-medium">Validity:</span> Oct 06,
                      2023 – Perpetual
                    </p>
                  </div>
                </div>
