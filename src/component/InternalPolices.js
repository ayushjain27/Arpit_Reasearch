      ...
      <div className="p-4 md:p-6 space-y-6 max-h-[600px] overflow-y-auto">
        ...
        <section ref={introductionRef} className="scroll-mt-24">
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <p>
                The Securities & Exchange Board of India (SEBI) has formulated
                the SEBI Research Analyst regulations, 2014 under the powers
                conferred to it according to the SEBI Act, 1992. These
                regulations became effective starting December 1, 2014. A
                Research Analyst is required to follow this code both in word
                and spirit.
              </p>
            </div>
          </div>
        ...
        <section ref={applicabilityRef} className="scroll-mt-24">
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <p>
                This policy shall be applicable to Research Analyst Arpit Goyal
                holding SEBI Registration No INH000013129 | BSE Enlistment 5860
                and Associates; if any of the Research Analyst.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              ...
              <ol className="list-decimal pl-6 mt-2 space-y-1">
                <li>
                  Preparation or publication of the content of the research
                  report; or
                </li>
                <li>
                  Providing a research report or making recommendation or giving
                  price target; or
                </li>
                <li>
                  Offering an opinion on any security that is listed or to be
                  listed on a Stock Exchange.
                </li>
              </ol>
              <p className="mt-2">
                This term includes any associates of research analyst who report
                directly or indirectly to the research analyst in connection to
        ...
        <section ref={limitationsRef} className="scroll-mt-24">
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <p className="font-medium">Research Analysts shall not:</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>
                  deal / trade in securities recommended / followed by the
                  research analyst within 30 days before and five days after the
                  publication of a research report;
                </li>
                <li>
                  deal / trade in securities that the research analyst reviews
                  in a manner contrary to his given recommendation;
                </li>
                <li>
                  purchase or receive securities of the issuer before the
                  issuer's initial public offering, if the issuer is principally
                  engaged in the same types of business as companies that the
                  research analyst follows or recommends.
                </li>
              </ul>
              <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 mt-3">
                <p className="text-blue-800 text-xs md:text-sm">
                  <strong>Note:</strong> The above restrictions to trade/deal in
                  ...
                  circumstances of the research analyst.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-gray-700 text-sm md:text-base space-y-2">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span>
                  ...
                  Industry as a consideration to commence or influence a
                  business relationship or for the receipt of compensation or
                  other benefits.
                </span>
              </div>
            </div>
        ...
        <section ref={disclosuresRef} className="scroll-mt-24">
          <div className="space-y-2">
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <p>
                Research Analyst shall disclose all material information about
                himself including the following in its research reports:
              </p>
              <ol className="list-decimal pl-6 mt-2 space-y-2">
                ...
                <li>
                  <strong>
                    Details with respect to Ownership and Material Conflict of
                    Interest
                  </strong>{" "}
                  such as:
                  <ul className="list-disc pl-6 mt-1 space-y-1">
                    <li>
                      Whether Research Analyst or its/his associate or relatives
                      have any financial interest in the subject company, if
                      yes, together with nature of such financial interest.
                    </li>
                    <li>
                      Whether Research Analyst or its/his associate or relatives
                      have actual / beneficial ownership of 1% or more
                      securities of subject company at the end of the month
                      immediately preceding the date of publication of research
                      report or date of public appearance, as the case may be.
                    </li>
                    <li>
                      Details of actual / beneficial ownership of one percent or
                      more securities of the subject company, at the end of
                      month immediately preceding the date of publication the
                      research report or date of public appearance.
                    </li>
                    <li>
                      Details of any material conflict of interest at the time
                      of publication of research report or at the time of public
                      appearance.
                    </li>
                    <li>
                      Details of any compensation received by Research Analyst
                      or its/his/her/their associates from the subject company
                      in past 12 months.
                    </li>
                    <li>
                      Details of whether Research Analyst or its associates have
                      managed or co-managed the public offering of subject
                      company in past 12 months.
                    </li>
                    <li>
                      Details of whether Research Analyst or its associates have
                      received any compensation for investment banking or
                      merchant banking or brokerage services from the subject
                      company in past 12 months.
                    </li>
                    <li>
                      Details of whether Research Analyst or its associates have
                      received any compensation for products or services other
                      than above from the subject company in past 12 months.
                    </li>
                    <li>
                      Details of any compensation or other benefits received by
                      Research Analyst or its/his/her/their associates from the
                      subject company or 3rd party in connection with the
                      research report.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <div className="flex items-start space-x-2 mt-1">
                    ...
                    <span>
                      ...
                      distribution of research report and the types of such
                      services provided by Research Analyst
                    </span>
                  </div>
                </li>
                <li>
                ...
                <li>
                  Whether Research Analyst has been engaged in market making
                  activity of the subject company
                </li>
                <li>
                  Such other disclosures in research reports / public appearance
                  as specified by SEBI under any other regulations.
                </li>
                <li>
                  Such Research Reports reflects the factual information about
                  the subject company and are based on reliable information.
                  Such reports also contain the definition of terms which are
                  used in making recommendations and such terms have been used
                  consistently.
                </li>
                <li>
                  If such Research Reports contain either a rating or price
                  target for at least 1 year, the same shall also provide for
                  the graph of daily closing price of such securities for the
                  period assigned or for a 3-year period, whichever is shorter.
                </li>
                <li>
                  Such Research Report Shall not be issued selectively to
                  internal trading personnel or to a particular client or group
                  of other clients in advance of other clients who are entitled
                  to receive the research report.
                </li>
                <li>
                  In case, Research Analyst appears in public media and make any
            ...
            <div className="text-gray-700 text-sm md:text-base">
              <ol className="list-decimal pl-6 space-y-2">
                <li>
                  ...
                  certification for research analysts as specified by SEBI.
                </li>
                <li>
                ...
                <li>
                  Research Analysts shall forthwith inform the Board in writing
                  about any information or particulars about him/her/them
                  submitted to SEBI, which are found to be false or misleading
                  in any material particular or are there is any change in
                  information already submitted.
                </li>
                <li>
                  Research Analyst shall conduct annual audit in respect of
                  compliance with the captioned SEBI Regulations from member of
                  ICAI or ICSI.
                </li>
              </ol>
              <div className="mt-4 text-right">
                <p className="font-medium">Mr. Arpit Goyal</p>
                <p>Place: Bhopal</p>
