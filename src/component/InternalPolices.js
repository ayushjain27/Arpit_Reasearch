            ...
            <div className="space-y-2">
              ...
              <div className="text-gray-700 text-sm md:text-base">
                <p>
                  ...
                  Kondagunta Venkatesh holding SEBI Registration No INH000013129 | BSE Enlistment 5860
              ...
              <div className="text-gray-700 text-sm md:text-base">
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>
                    ...
                    research analyst within 30 days before and five days after
                  ...
                  <li>
                    ...
                    companies that the research analyst follows or recommends.
                  </li>
                </ul>
                <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 mt-3">
                  <p className="text-blue-800 text-xs md:text-sm">
                    <strong>Note:</strong> The above restrictions to trade/deal
                    in securities shall not be applicable in case of significant
                    news or event concerning the subject company or based upon
                    an unanticipated significant change in the personal
                    financial circumstances of the research analyst.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="text-gray-700 text-sm md:text-base">
                ...
                <ol className="list-decimal pl-6 mt-2 space-y-2">
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-6 mt-1 space-y-1">
                      <li>
                        ...
                        company, if yes, together with nature of such financial
                        interest.
                      </li>
                      <li>
                        Whether Research Analyst or its/his associate or
                        relatives have actual / beneficial ownership of 1% or
                        more securities of subject company at the end of the
                        month immediately preceding the date of publication of
                        research report or date of public appearance, as the
                        case may be.
                      </li>
                      <li>
                        Details of actual / beneficial ownership of one percent
                        or more securities of the subject company, at the end of
                      ...
                      <li>
                        ...
                        of publication of research report or at the time of
                        public appearance.
                      </li>
                      <li>
                        Details of any compensation received by Research Analyst
                        or its/his/ her/their associates from the subject
                        company in past 12 months.
                      </li>
                      <li>
                        Details of whether Research Analyst or its associates
                        have managed or co-managed the public offering of
                        subject company in past 12 months.
                      </li>
                      <li>
                        Details of whether Research Analyst or its associates
                        have received any compensation for investment banking or
                        merchant banking or brokerage services from the subject
                        company in past 12 months.
                      </li>
                      <li>
                        Details of whether Research Analyst or its associates
                        have received any compensation for products or services
                        other than above from the subject company in past 12
                        months.
                      </li>
                      <li>
                        Details of any compensation or other benefits received
                        by Research Analyst or its/his/her/their associates from
                        the subject company or 3rd party in connection with the
                        research report.
                      </li>
                    </ul>
                  </li>
                  ...
                  <li>
                    ...
                    period assigned or for a 3-year period, whichever is
                    shorter.
                  </li>
                  <li>
                  ...
                  <li>
                    In case, Research Analyst appears in public media and make
                    any recommendation, the disclosure of his / its name,
                    registration status and details of financial interest shall
                    invariably made at the time of making such recommendation or
                    offering any opinion in his personal capacity, responding to
                    any queries of audience or journalists in personal capacity
                    and communicating the research report or its substance
              ...
              <div className="text-gray-700 text-sm md:text-base">
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    him/her/them submitted to SEBI, which are found to be false
                    or misleading in any material particular or are there is any
                    change in information already submitted.
                  </li>
                  <li>
                    Research Analyst shall conduct annual audit in respect of
                    compliance with the captioned SEBI Regulations from member
                    of ICAI or ICSI.
                  </li>
                </ol>
...
export default InternalPoliciesContent;