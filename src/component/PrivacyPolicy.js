      ...
      <div className="p-4 md:p-6 space-y-4 max-h-[600px] overflow-y-auto">
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          ...
          <div className="space-y-2 text-gray-700 text-sm md:text-base">
            <p>
              This privacy policy sets out how Arpit Goyal uses and protects any
              information that you give Arpit Goyal when you use this website.
            </p>
            <p>
              Arpit Goyal is committed to ensuring that your privacy is
            ...
            <p>
              Arpit Goyal may change this policy from time to time by updating
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          ...
          <div className="space-y-2 text-gray-700 text-sm md:text-base">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Demographic information such as postcode, country, city, state
              </li>
              <li>
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          ...
          <div className="space-y-2 text-gray-700 text-sm md:text-base">
            ...
            <p>
              ...
              please contact us by clicking here If you believe that any
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          ...
          <div className="space-y-2 text-gray-700 text-sm md:text-base mb-3">
            <p>
          ...
          <h3 className="text-base md:text-lg font-bold text-teal-800 mt-3 mb-2">
            Contact Form
          </h3>
          <div className="space-y-2 text-gray-700 text-sm md:text-base">
            <p>
              Information submitted through contact forms is retained for
              customer service purposes and is not used for marketing purposes
              without your consent.
            </p>
          </div>
        </section>

        {/* Cookies Details Section */}
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-2">
            Cookies
          </h2>
        ...
        <section className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 md:p-6 rounded-lg">
          ...
          <div className="space-y-3 text-gray-700 text-sm md:text-base">
            <p>
              <strong>How we protect your data:</strong> We implement
              appropriate technical and organizational measures to ensure a
              level of security appropriate to the risk.
            </p>
            <p>
              <strong>Data breach procedures:</strong> We have procedures in
              place to deal with any suspected personal data breach and will
              notify you and any applicable regulator of a breach where we are
              legally required to do so.
            </p>
            <p>
              <strong>Industry regulatory disclosure requirements:</strong> As a
              SEBI registered Research Analyst, we comply with all applicable
        ...
        <section className="bg-gradient-to-r from-blue-50 to-teal-50 p-4 md:p-6 rounded-lg border border-blue-200">
          ...
          <div className="space-y-2 text-blue-700 text-sm md:text-base">
            <p>For any privacy-specific concerns, please contact us at:</p>
            <p className="font-medium">Email: agbpl2354@gmail.com</p>
          </div>
        </section>
      </div>
